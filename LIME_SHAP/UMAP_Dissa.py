...
mlp.load_state_dict(torch.load("Dissa_mlp_relief.pth", map_location=device))
mlp.eval()
...
plt.title("UMAP Visualization of Dissa Relief Classifier", fontsize=20, weight='bold')
